...
const Hero = () => {
  return (
    <div className='pb-10 pt-36'>
      ...
      <div className="absolute h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.03] bg-grid-black/[0.2] flex items-center justify-center top-0 left-0">
      ...
      <div className='flex justify-center relative my-20 z-10'>
        ...
        <h2 className='uppercase tracking-widest text-xs text-center text-blue-100 max-w-80'>
          To all calisthenics coaches and fitness skool owners  
        </h2>  
